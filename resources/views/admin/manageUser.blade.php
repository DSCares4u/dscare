...
<div class="flex-1 flex mt-12 items-center justify-between ">
    <h1 class="text-lg font-semibold  py-2">Manage Users (<span id="counting">0</span>)</h1>
    <a href="/admin/manage-user/insert" class="bg-indigo-500 hover:bg-indigo-800 text-white px-3 py-2 rounded">
        ...
        <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody id="calling" >
                    <tr class="mt-5">
                        ...
                        <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">Rajiv Kumar</td> 
                        <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">789456123</td> 
                        <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">Line Bazar, Purnea</td> 
                        <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">54/ Male</td> 
