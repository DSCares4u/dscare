...
<div class="upper mt-5">
    <div class="head flex items-center justify-center h-80" style="background-image: url('/images/plans-head.jpg');">
        <h3 class=" uppercase  text-white font-bold text-4xl tracking-wider">Health Care packages <p
                class="text-sm text-center mt-3 font-medium tracking-widest">Home / Healthcare Packages</p>
        </h3>
    </div>
</div>
