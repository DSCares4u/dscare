...
<body class='p-0 font-sans'>
    ...
    <div class="bg-[#e58e26] items-center justify-end mb-10  w-full flex md:flex md:w-auto md:order-1 p-2">
        <ul class="flex flex-col mt-4 font-light text-sm  gap-6 md:flex-row md:mt-0 ">
            <li>
    ...
    <!-- <div class="header">
    <nav class="p-10 float-right justify-end">
  ...
  <nav class="bg-white dark:bg-gray-900 fixed w-full  top-0 start-0 border-b border-gray-200 dark:border-gray-600 shadow-xl">
